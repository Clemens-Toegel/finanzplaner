...
mixin _$PurchaseItem {
 ...
 int? get id; ExpenseAccountType get accountType; String get description; String get vendor; String get category; double get amount; DateTime get date; bool get isDeductible; String get notes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,accountType,description,vendor,category,amount,date,isDeductible,notes);

@override
String toString() {
  return 'PurchaseItem(id: $id, accountType: $accountType, description: $description, vendor: $vendor, category: $category, amount: $amount, date: $date, isDeductible: $isDeductible, notes: $notes)';
}
...
@useResult
$Res call({
 int? id, ExpenseAccountType accountType, String description, String vendor, String category, double amount, DateTime date, bool isDeductible, String notes
});
...
/// Create a copy of PurchaseItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? accountType = null,Object? description = null,Object? vendor = null,Object? category = null,Object? amount = null,Object? date = null,Object? isDeductible = null,Object? notes = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  ExpenseAccountType accountType,  String description,  String vendor,  String category,  double amount,  DateTime date,  bool isDeductible,  String notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PurchaseItem() when $default != null:
return $default(_that.id,_that.accountType,_that.description,_that.vendor,_that.category,_that.amount,_that.date,_that.isDeductible,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  ExpenseAccountType accountType,  String description,  String vendor,  String category,  double amount,  DateTime date,  bool isDeductible,  String notes)  $default,) {final _that = this;
switch (_that) {
case _PurchaseItem():
return $default(_that.id,_that.accountType,_that.description,_that.vendor,_that.category,_that.amount,_that.date,_that.isDeductible,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  ExpenseAccountType accountType,  String description,  String vendor,  String category,  double amount,  DateTime date,  bool isDeductible,  String notes)?  $default,) {final _that = this;
switch (_that) {
case _PurchaseItem() when $default != null:
return $default(_that.id,_that.accountType,_that.description,_that.vendor,_that.category,_that.amount,_that.date,_that.isDeductible,_that.notes);case _:
  return null;
...
class _PurchaseItem extends PurchaseItem {
  const _PurchaseItem({this.id, required this.accountType, required this.description, required this.vendor, required this.category, required this.amount, required this.date, required this.isDeductible, required this.notes}): super._();
...
/// Create a copy of PurchaseItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? accountType = null,Object? description = null,Object? vendor = null,Object? category = null,Object? amount = null,Object? date = null,Object? isDeductible = null,Object? notes = null,}) {
